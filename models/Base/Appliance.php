 ...
 */
abstract class Appliance implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ApplianceTableMap';
    ...
    /**
     * Compares this with another <code>Appliance</code> instance.  If
     * <code>obj</code> is an instance of <code>Appliance</code>, delegates to
     * <code>equals(Appliance)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Appliance The current object, for fluid interface
     */
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildApplianceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Appliance::setDeleted()
     * @see Appliance::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildApplianceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ApplianceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO appliance (%s) VALUES (%s)',
    ...
    {
        $pos = ApplianceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Appliance (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Appliance Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ApplianceTableMap::DEFAULT_STRING_FORMAT);
    }
