...
abstract class Authentication implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AuthenticationTableMap';
    ...
    /**
     * Initializes internal state of Base\Authentication object.
     */
     ...
     * @return $this|\Authentication The current object (for fluent API support)
     */
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d") !== $this->timestamp->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AuthenticationTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[AuthenticationTableMap::COL_EMAIL] = true;
        }
    ...
    public function setPassword($v)
    {
        ...
        if ($this->password !== $v) {
            $this->password = $v;
            $this->modifiedColumns[AuthenticationTableMap::COL_PASSWORD] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[AuthenticationTableMap::COL_USERID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AuthenticationTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->timestamp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AuthenticationTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AuthenticationTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            $this->password = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AuthenticationTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Authentication'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AuthenticationTableMap::COL_TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = 'Timestamp';
        }
        if ($this->isColumnModified(AuthenticationTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'Email';
        }
        if ($this->isColumnModified(AuthenticationTableMap::COL_PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = 'Password';
        }
        if ($this->isColumnModified(AuthenticationTableMap::COL_USERID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthenticationTableMap::COL_TIMESTAMP)) {
            $criteria->add(AuthenticationTableMap::COL_TIMESTAMP, $this->timestamp);
        }
        if ($this->isColumnModified(AuthenticationTableMap::COL_EMAIL)) {
            $criteria->add(AuthenticationTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(AuthenticationTableMap::COL_PASSWORD)) {
            $criteria->add(AuthenticationTableMap::COL_PASSWORD, $this->password);
        }
        if ($this->isColumnModified(AuthenticationTableMap::COL_USERID)) {
            $criteria->add(AuthenticationTableMap::COL_USERID, $this->userid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Authentication (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Authentication Clone of current object.
     * @throws PropelException
     */
