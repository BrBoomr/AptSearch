 ...
 */
abstract class Utility implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UtilityTableMap';
    ...
    /**
     * Compares this with another <code>Utility</code> instance.  If
     * <code>obj</code> is an instance of <code>Utility</code>, delegates to
     * <code>equals(Utility)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Utility The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 7; // 7 = UtilityTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Utility'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUtilityQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Utility::setDeleted()
     * @see Utility::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUtilityQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UtilityTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO utility (%s) VALUES (%s)',
    ...
    {
        $pos = UtilityTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Utility (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Utility Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(UtilityTableMap::DEFAULT_STRING_FORMAT);
    }
