...
/**
 * Base class that represents a row from the 'phone' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Phone implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PhoneTableMap';
    ...
    /**
     * Compares this with another <code>Phone</code> instance.  If
     * <code>obj</code> is an instance of <code>Phone</code>, delegates to
     * <code>equals(Phone)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Phone The current object, for fluid interface
     */
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[PhoneTableMap::COL_NUMBER] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[PhoneTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPhoneQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPhoneQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PhoneTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = PhoneTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        return (string) $this->exportTo(PhoneTableMap::DEFAULT_STRING_FORMAT);
    }
