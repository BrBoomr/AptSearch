 ...
 * @method     ChildEmailQuery orderByTimestamp($order = Criteria::ASC) Order by the Timestamp column
 * @method     ChildEmailQuery orderByUserid($order = Criteria::ASC) Order by the UserID column
 * @method     ChildEmailQuery orderByEmail($order = Criteria::ASC) Order by the Email column
 * @method     ChildEmailQuery orderByDescription($order = Criteria::ASC) Order by the Description column
 *
 * @method     ChildEmailQuery groupById() Group by the ID column
 * @method     ChildEmailQuery groupByTimestamp() Group by the Timestamp column
 * @method     ChildEmailQuery groupByUserid() Group by the UserID column
 * @method     ChildEmailQuery groupByEmail() Group by the Email column
 * @method     ChildEmailQuery groupByDescription() Group by the Description column
 *
 ...
 *
 * @method     ChildEmailQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildEmailQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildEmailQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 * @method     ChildEmailQuery joinWithUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the User relation
 *
 * @method     ChildEmailQuery leftJoinWithUser() Adds a LEFT JOIN clause and with to the query using the User relation
 * @method     ChildEmailQuery rightJoinWithUser() Adds a RIGHT JOIN clause and with to the query using the User relation
 * @method     ChildEmailQuery innerJoinWithUser() Adds a INNER JOIN clause and with to the query using the User relation
 *
...
abstract class EmailQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, Timestamp, UserID, Email, Description FROM email WHERE ID = :p0';
        try {
    ...
    public function filterByTimestamp($timestamp = null, $comparison = null)
    {
        if (is_array($timestamp)) {
            ...
            if (isset($timestamp['min'])) {
                $this->addUsingAlias(EmailTableMap::COL_TIMESTAMP, $timestamp['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($timestamp['max'])) {
                $this->addUsingAlias(EmailTableMap::COL_TIMESTAMP, $timestamp['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EmailTableMap::COL_TIMESTAMP, $timestamp, $comparison);
    }
    ...
    public function filterByUserid($userid = null, $comparison = null)
    {
        if (is_array($userid)) {
            $useMinMax = false;
            if (isset($userid['min'])) {
                $this->addUsingAlias(EmailTableMap::COL_USERID, $userid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userid['max'])) {
                $this->addUsingAlias(EmailTableMap::COL_USERID, $userid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EmailTableMap::COL_USERID, $userid, $comparison);
    }
    ...
    public function filterByEmail($email = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EmailTableMap::COL_EMAIL, $email, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EmailTableMap::COL_DESCRIPTION, $description, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildEmailQuery The current query, for fluid interface
     */
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            return $this
                ->addUsingAlias(EmailTableMap::COL_USERID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EmailTableMap::COL_USERID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
