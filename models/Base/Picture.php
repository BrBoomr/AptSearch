...
abstract class Picture implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PictureTableMap';
    ...
    public function setLink($v)
    {
        ...
        if ($this->link !== $v) {
            $this->link = $v;
            $this->modifiedColumns[PictureTableMap::COL_LINK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 5; // 5 = PictureTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Picture'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO picture (%s) VALUES (%s)',
