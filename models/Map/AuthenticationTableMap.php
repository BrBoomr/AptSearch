...
class AuthenticationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.AuthenticationTableMap';
     ...
     */
    const OM_CLASS = '\\Authentication';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Authentication';
     ...
     */
    const COL_TIMESTAMP = 'authentication.Timestamp';

    /**
     * the column name for the Email field
     */
    const COL_EMAIL = 'authentication.Email';

    /**
     * the column name for the Password field
     */
    const COL_PASSWORD = 'authentication.Password';

    /**
     * the column name for the UserID field
     */
    const COL_USERID = 'authentication.UserID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Timestamp', 'Email', 'Password', 'Userid', ),
        self::TYPE_CAMELNAME     => array('id', 'timestamp', 'email', 'password', 'userid', ),
        self::TYPE_COLNAME       => array(AuthenticationTableMap::COL_ID, AuthenticationTableMap::COL_TIMESTAMP, AuthenticationTableMap::COL_EMAIL, AuthenticationTableMap::COL_PASSWORD, AuthenticationTableMap::COL_USERID, ),
        self::TYPE_FIELDNAME     => array('ID', 'Timestamp', 'Email', 'Password', 'UserID', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Timestamp' => 1, 'Email' => 2, 'Password' => 3, 'Userid' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'timestamp' => 1, 'email' => 2, 'password' => 3, 'userid' => 4, ),
        self::TYPE_COLNAME       => array(AuthenticationTableMap::COL_ID => 0, AuthenticationTableMap::COL_TIMESTAMP => 1, AuthenticationTableMap::COL_EMAIL => 2, AuthenticationTableMap::COL_PASSWORD => 3, AuthenticationTableMap::COL_USERID => 4, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'Timestamp' => 1, 'Email' => 2, 'Password' => 3, 'UserID' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Authentication');
        $this->setPackage('');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AuthenticationTableMap::COL_TIMESTAMP);
            $criteria->addSelectColumn(AuthenticationTableMap::COL_EMAIL);
            $criteria->addSelectColumn(AuthenticationTableMap::COL_PASSWORD);
            $criteria->addSelectColumn(AuthenticationTableMap::COL_USERID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Authentication) { // it's a model object
